        ...
        <div class="row mb-2">
          <div class="col-sm-12">
            ...
            <div class="card border-0 shadow rounded">
                <div class="card-body">
                    <a href="{{ route('admin.lelang.create') }}" class="btn btn-md btn-secondary mb-3 float-right">Tambah Barang</a>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                        action="{{ route('admin.lelang.destroy', $row->id) }}" method="POST">
                                        <a href="{{ route('admin.lelang.edit', $row->id) }}"
