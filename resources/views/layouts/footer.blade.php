...
<div class="row g-5 mb-5">
    <div class="col-lg-4">
        <div class="mb-4 footer-logo-wrap"><a href="#" class="footer-logo">Pelelangan<span>Online</span></a></div>
...
<div class="border-top copyright">
    <div class="row pt-4">
        <div class="col-lg-6">
            <p class="mb-2 text-center text-lg-start">Copyright &copy; Pelelangan Online. All Rights Reserved.</a>
</p>
        </div>
